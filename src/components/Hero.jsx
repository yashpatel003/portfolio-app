...
import useReducedMotionSafe from "../hooks/useReducedMotionSafe" // 🧠 new hook import

export default function Hero({ onContact }) {
  const [offsetY, setOffsetY] = useState(0)
  const reduceMotion = useReducedMotionSafe() // 🔍 detect motion preference

  useEffect(() => {
    if (reduceMotion) return // 🚫 disable scroll parallax on low-power or reduced motion
  ...
  return (
    <section
      ...
      style={{
        transform: reduceMotion ? "none" : `translateY(${offsetY * -0.3}px)`,
      ...
      <div className="flex flex-col lg:flex-row items-start gap-6">
        ...
        >
          <motion.div
            ...
            style={{
              transform: reduceMotion ? "none" : `translateY(${offsetY * 0.1}px)`,
              transition: "transform 0.1s linear",
            }}
          >
          ...
          <motion.h1
            ...
            style={{
              transform: reduceMotion ? "none" : `translateY(${offsetY * -0.15}px)`,
              transition: "transform 0.1s linear",
            }}
          >
        ...
        <motion.div
          ...
          style={{
            transform: reduceMotion ? "none" : `translateY(${offsetY * 0.2}px)`,
            transition: "transform 0.1s linear",
          }}
        >
